...
BgCamInfo gDTRisingPlatformsColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDTRisingPlatformsCol = { 
    { -1900, 0, -1900 },
    { 2100, 1200, 2000 },
    ARRAY_COUNT(gDTRisingPlatformsColVertices), gDTRisingPlatformsColVertices,
    ARRAY_COUNT(gDTRisingPlatformsColPolygons), gDTRisingPlatformsColPolygons,
...
BgCamInfo gDTFallingLadderColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gDTFallingLadderColSurfaceType[] = {
    {0x00400000, 0x000007CA},   {0x00600000, 0x000007CA},
};
...
CollisionHeader gDTFallingLadderCol = { 
    { -160, 0, -20 },
    { 160, 1400, 0 },
    ARRAY_COUNT(gDTFallingLadderColVertices), gDTFallingLadderColVertices,
    ARRAY_COUNT(gDTFallingLadderColPolygons), gDTFallingLadderColPolygons,
...
BgCamInfo gDTSlidingPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDTSlidingPlatformCol = { 
    { -500, -400, -500 },
    { 500, 0, 500 },
    ARRAY_COUNT(gDTSlidingPlatformColVertices), gDTSlidingPlatformColVertices,
    ARRAY_COUNT(gDTSlidingPlatformColPolygons), gDTSlidingPlatformColPolygons,
