...
BgCamInfo gWaterTrialIceBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTrialIceBlockColSurfaceType[] = {
    {0x0000A000, 0x000007CC},   {0x00E0A000, 0x000007CC},
};
...
CollisionHeader gWaterTrialIceBlockCol = { 
    { -600, 0, -600 },
    { 600, 1000, 600 },
    ARRAY_COUNT(gWaterTrialIceBlockColVertices), gWaterTrialIceBlockColVertices,
    ARRAY_COUNT(gWaterTrialIceBlockColPolygons), gWaterTrialIceBlockColPolygons,
...
BgCamInfo gClearBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gClearBlockCol = { 
    { -500, -400, -500 },
    { 500, 0, 500 },
    ARRAY_COUNT(gClearBlockColVertices), gClearBlockColVertices,
    ARRAY_COUNT(gClearBlockColPolygons), gClearBlockColPolygons,
...
BgCamInfo gFireTrialPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTrialPlatformCol = { 
    { -2401, -611, -5400 },
    { 3600, 1206, 9002 },
    ARRAY_COUNT(gFireTrialPlatformColVertices), gFireTrialPlatformColVertices,
    ARRAY_COUNT(gFireTrialPlatformColPolygons), gFireTrialPlatformColPolygons,
