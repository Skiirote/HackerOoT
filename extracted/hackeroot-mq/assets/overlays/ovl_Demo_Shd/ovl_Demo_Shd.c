...
static u64 ovl_Demo_ShdTex_000000[256];
static u64 ovl_Demo_ShdTex_000800[256];
static Vtx ovl_Demo_ShdVtx_001000[197];
static Gfx D_809932D0[24];
static Gfx D_80993390[37];
static Gfx D_809934B8[41];

static u64 ovl_Demo_ShdTex_000000[256] = {
#include "assets/overlays/ovl_Demo_Shd/ovl_Demo_ShdTex_000000.i8.inc.c"
};

static u64 ovl_Demo_ShdTex_000800[256] = {
#include "assets/overlays/ovl_Demo_Shd/ovl_Demo_ShdTex_000800.i8.inc.c"
};

static Vtx ovl_Demo_ShdVtx_001000[197] = {
#include "assets/overlays/ovl_Demo_Shd/ovl_Demo_ShdVtx_001000.vtx.inc"
};
...
static Gfx D_809932D0[24] = {
    ...
    gsDPLoadTextureBlock(ovl_Demo_ShdTex_000000, G_IM_FMT_I, G_IM_SIZ_8b, 16, 128, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_WRAP, 4, 7, G_TX_NOLOD, 1),
    gsDPLoadMultiBlock(ovl_Demo_ShdTex_000800, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
static Gfx D_80993390[37] = {
    gsSPVertex(ovl_Demo_ShdVtx_001000, 32, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[32], 32, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[64], 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[90], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

static Gfx D_809934B8[41] = {
    gsSPVertex(&ovl_Demo_ShdVtx_001000[93], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[125], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[155], 32, 0),
    ...
    gsSPVertex(&ovl_Demo_ShdVtx_001000[186], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(4, 6, 7, 0, 4, 7, 5, 0),
    gsSPVertex(&ovl_Demo_ShdVtx_001000[194], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
