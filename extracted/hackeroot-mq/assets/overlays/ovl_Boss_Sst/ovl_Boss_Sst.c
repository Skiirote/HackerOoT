...
static Vtx ovl_Boss_SstVtx_000038[4];
static u64 ovl_Boss_SstTex_000078[128];
static Gfx sIntroVanishDList[17];
static Vtx ovl_Boss_SstVtx_000500[3];
static u64 ovl_Boss_SstTex_000530[128];
...
static Vtx ovl_Boss_SstVtx_000038[4] = {
#include "assets/overlays/ovl_Boss_Sst/ovl_Boss_SstVtx_000038.vtx.inc"
};

static u64 ovl_Boss_SstTex_000078[128] = {
#include "assets/overlays/ovl_Boss_Sst/ovl_Boss_SstTex_000078.i8.inc.c"
};
...
static Gfx sIntroVanishDList[17] = {
    ...
    gsDPLoadTextureBlock(ovl_Boss_SstTex_000078, G_IM_FMT_I, G_IM_SIZ_8b, 16, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(ovl_Boss_SstVtx_000038, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

static Vtx ovl_Boss_SstVtx_000500[3] = {
#include "assets/overlays/ovl_Boss_Sst/ovl_Boss_SstVtx_000500.vtx.inc"
};

static u64 ovl_Boss_SstTex_000530[128] = {
#include "assets/overlays/ovl_Boss_Sst/ovl_Boss_SstTex_000530.i8.inc.c"
};

static Gfx sShadowDList[16] = {
    gsDPPipeSync(),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(ovl_Boss_SstTex_000530, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
    ...
    gsSPVertex(ovl_Boss_SstVtx_000500, 3, 0),
